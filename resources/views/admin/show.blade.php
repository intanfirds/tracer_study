                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <th>Profesi</th>
                            <td>
                                @if ($alumni->detailProfesi->isNotEmpty())
                                    @if ($alumni->detailProfesi->first()->kategori_id == 3)
                                        Belum bekerja
                                    @else
                                        {{ $alumni->detailProfesi->first()->profesi ?? '-' }}
                                    @endif
                                @endif
                            </td>
                        </tr>
                        <tr>
                            <th>Masa Tunggu</th>
                            <td>{{ $alumni->detailProfesi->first()->masa_tunggu ?? '-' }} bulan</td>
                        </tr>
                    </table>
                </div>
                    ...
                    @if ($alumni->instansi)
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                <th>Jenis</th>
                                <td>
                                    @if ($alumni->instansi && $alumni->instansi->jenisInstansi)
                                        {{ $alumni->instansi->jenisInstansi->nama_jenis_instansi }}
                                    @else
                                        -
                                    @endif
                                </td>
